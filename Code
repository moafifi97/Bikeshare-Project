...
def get_filters():
    ...
    while True:
        ...
        month = input("\n please select a month (January, February, March, April, May, June, All) or choose all to apply no month filter\n").title()
        if month in months:
            break
        else:
    ...
    while True:
        ...
        day = input("\n please select a day(Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, All)or choose all to apply no day filter \n").title()         
        if day in days:
            break
        else:
